...
def search_website():
    try:
        ...
        if website in data:
            messagebox.showinfo(website, f'Website: {website}\nEmail: '
...
website_entry = Entry(width=23, bg='white', fg='black', highlightthickness=1)
...
# Buttons
search_button = Button(text='Search', highlightbackground='white', highlightthickness=1, command=search_website)
search_button.grid(column=2, row=1, pady=4)

generate_button = Button(text='Generate', highlightbackground='white',
                         highlightthickness=1, command=generate_my_password)
